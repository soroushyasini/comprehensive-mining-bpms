...
3. تاریخ‌های شمسی با قالب `YYYY/MM/DD` وارد می‌شوند و API مقدار میلادی متناظر را در همان عملیات می‌سازد.
   پنل برای مهلت دریافت اسناد و مهلت پاسخ یک datepicker شمسی داخلی و بدون وابستگی بیرونی دارد؛ هفته از شنبه آغاز می‌شود و مقدار انتخابی پیش از ارسال دوباره در API اعتبارسنجی می‌شود.
